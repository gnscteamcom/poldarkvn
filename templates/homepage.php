<?php
	...
	if ($newestSeries->getNumberOfOnlineEpisodes() == 0) {
		$newestSeries = Poldark::getSeries($selectedSeries-1);
	}
...
<div class="banner">
	<div class="banner-text text-center visible-xs">
		...
		<button class="btn btn-success btn-lg watch-episode latest animated infinite pulse" data-toggle="modal" data-target="#video-player" data-series="<?php echo $newestSeries->getSeriesNumber(); ?>" data-episode="<?php echo $newestEpisode ?>">XEM TẬP MỚI NHẤT<br><small>Mùa <?php echo $newestSeries->getSeriesNumber(); ?> - Tập <?php echo $newestEpisode ?></small></button><br>
	...
	<div class="col-md-offset-7 col-sm-offset-7  hidden-xs">
		...
		<button class="btn-banner btn btn-success btn-lg watch-episode latest animated infinite pulse" data-toggle="modal" data-target="#video-player" data-series="<?php echo $newestSeries->getSeriesNumber(); ?>" data-episode="<?php echo $newestEpisode ?>">XEM TẬP MỚI NHẤT<br><small>Mùa <?php echo $newestSeries->getSeriesNumber(); ?> - Tập <?php echo $newestEpisode ?></small></button><br><br>
...
<script src="src/jwplayer/jwplayer.js?v=06122016031957"></script>
<script src="src/jwplayer/vttparser.js?v=28112016050303"></script>
<script src="src/jwplayer/polyfills.vttrenderer.js?v=28112016050303"></script>
<script src="src/jwplayer/provider.html5.js?v=28112016050303"></script>
<script src="src/jwplayer/provider.sea.js"></script>
<script src="src/script.js?v=06122016013603"></script>