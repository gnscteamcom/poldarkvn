	...
	<div class="col-md-8 col-sm-12">
		<div class="text-center">					
			<h3><strong>Tập <?php echo $upcomingInfo['number'] . '/' . $seriesInfo['numberOfEpisodes'] ?></strong></h3>
	   		...
	   		<p><strong>Người dịch:</strong> <?php echo implode(", ", $upcomingInfo['translators']); ?></p>
	   		<p><strong>Tình trạng:</strong> <span class="text-info">Đang dịch (<?php echo $upcomingInfo['translatedPercent']; ?>%)</span></p>
